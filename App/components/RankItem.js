        ...
        <div className='w-full h-full'>
        {
            leaderboardList.length != 0 ?   
                leaderboardList.map((item, index) => {
                    return(
                        <>
                            <div className='relative w-full h-[70px] flex items-center justify-center drop-shadow-[0_10px_60px_rgba(235,245,243,1)] bg-white rounded-[15px] hover:cursor-pointer hover:bg-light_morning_blue' key={item.id}>
                                <div className='relative w-[95%] h-[50px]'>
                                    <div className='absolute w-[50px] h-[50px]'>
                                        <div className='w-full h-full flex items-center justify-center text-xl font-poppins text-steel_teal font-semibold select-none truncate ...'>
                                            {
                                                index === 0 ?
                                                (
                                                    (index + 1) + "st"
