    ...
    <div className='flex justify-center items-center w-screen h-screen'>
        <div className=' w-[70%] h-[80%]'>
            ...
            <div className='w-[50%] h-[40%] mx-auto'>
                <div className='w-full h-[28%] grid place-items-center drop-shadow-[0_10px_60px_rgba(226,236,249,1)] bg-white rounded-[15px] hover:cursor-pointer hover:bg-purple_light' onClick={() => signIn('google')}>
                ...
                <div className='w-full h-[28%] grid place-items-center drop-shadow-[0_10px_60px_rgba(226,236,249,1)] bg-white rounded-[15px] hover:cursor-pointer hover:bg-purple_light' onClick={() => signIn('github')}>
                    <div className='absolute grid place-items-center h-full w-full'>
                ...
                <div className='w-full h-[28%] grid place-items-center drop-shadow-[0_10px_60px_rgba(226,236,249,1)] bg-white rounded-[15px] hover:cursor-pointer hover:bg-purple_light' onClick={() => signIn('facebook')}>
                    <div className='absolute grid place-items-center h-full w-full'>
